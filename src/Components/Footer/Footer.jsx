      ...
      <div className="container">
        <section className={s.sections}>
          ...
          <section className={s.section2}>
            ...
            <ul>
              <li>87, Anna nagar, Adyar, Chennai</li>
              <li>
                <a href="mailto:sreedharshniilango@gmail.com">sreedharshniilango@gmail.com</a>
              </li>
              <li>
                <a href="tel:+01 82200816711">8220816711</a>
              </li>
            </ul>
          </section>
        ...
        <p className={s.copyRights}>
          ...
          <a
            href="https://www.linkedin.com/in/sreedharshniilango?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            target="_blank"
          >
           Dharsh
          </a>
